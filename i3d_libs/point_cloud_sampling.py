...
def _generate_training_data(vertices: torch.tensor, # A tensor with the mesh vertices in 3D.
    n_on_surf: int, # number of sampling points
    n_off_surf: int, # number of sampling points
    ...
    return coord_dict
class PointCloudSampling(Dataset):
    def __init__(self, mesh_path: str, cfg, batch_size: int,
                 use_curvature: bool = False,
        ...
        self.cfg = cfg
        self.beta = getattr(self.cfg, "beta", 1.)
    ...
    def __getitem__(self):
        ...
        if self.refresh_sdf:
            ...
            samples = _generate_training_data(
